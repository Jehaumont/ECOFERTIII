...
% state all parameters alphabetically {type, value, unit, data type,
% comment}
crop_rotation   =           {"Input",   repmat(["Cauli","Leek"],1,43),...
                                                    "--",       "string", "vector with the crop rotation 1 = cauliflower, 2 = leek"};
fertDecisionRule=           {"Input",   "FIX",     "DL",       "string",  "determines which decision rule is used to calculate the target values for fertilization"};
...
%%%%%%%% SOLUTE PARAMETERS %%%%%%%%
applied_fert    =           {"Logging", [],      "g/cm²",    "numeric", 'total amount of fertilizers applied'};
...
%%%%%%%% SOLUTE PARAMETERS %%%%%%%%
applied_fert    =           {"Logging", [],     "g/cm²",    "numeric",  "total amount of fertilizer applied"};
acsolio         =           {"State",   [],     "g/kg",     "numeric",  ['absorbed solute',...
                                                                        ' concentration in the immobile',...
                                                                        ' zone for the acutal time',...
                                                                        ' step for each compartment',...
...
water_balance   =           {"Logging", [],     "cm",       "numeric",     "cumulative water fluxes [day, top_flux, bot_flux, cum_tranp]"};
WCSoil_log      =           {"Logging", zeros(nComp{2},1),...
